...
namespace UI
{
    public partial class Pantalla_Principal_B : System.Windows.Forms.Form
    {
      ...
      //MINIMIZAR, MAXIMIZAR, RESTAURAR EL FORMULARIO
        ...
        private void closedForm(object sender, FormClosedEventArgs e)
        {
            ...
            {
                btnABM.BackColor = Color.FromArgb(37, 54, 75);
                //More Codes
            }
               
            if (Application.OpenForms["Form2"] == null){
                btnRepo.BackColor = Color.FromArgb(37, 54, 75);
                //More Codes
            }
            if (Application.OpenForms["Form3"] == null)
            {
               btnHistorial.BackColor = Color.FromArgb(37, 54, 75);
                //More Codes
            }
        ...
        {
            openFormOnPanel<UI.Alta_Empleado>();
            btnABM.BackColor = Color.FromArgb(0, 100, 182);
        }

        private void btnClinicalHistory_Click(object sender, EventArgs e)
        {
            openFormOnPanel<UI.Apertura_Planilla>();
            btnRepo.BackColor = Color.FromArgb(0, 100, 182);
        }

        private void btnCalendar_Click(object sender, EventArgs e)
        {
            openFormOnPanel<UI.Entradas>();
            btnHistorial.BackColor = Color.FromArgb(0, 100, 182);
        }
        ...
        {
            openFormOnPanel<UI.Consulta_Usuario>();
            timer1.Start();
        }
